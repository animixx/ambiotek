...
/**
 * Class AccesoDiosTable
 *
 * @package Eye3\CaminosBundle\Model
 *
 * @DataTable\Table(id="accesoDiosTable",displayLength=10, serverSideProcessing = false)
 */
class AccesoDiosTable extends QueryBuilderDataTable implements QueryBuilderDataTableInterface
{
	...
	/**
     * @var string
     * @DataTable\Column(source="registro.detalle", name="Detalle")
    */
    public $detalle;
